...
import com.korea.soft.templv2.domain.entity.Phonics;
import com.korea.soft.templv2.domain.entity.TrainingHist;
import org.springframework.data.jpa.repository.JpaRepository;
import org.springframework.data.querydsl.QuerydslPredicateExecutor;


public interface TrainingHistRepository extends JpaRepository<TrainingHist, Long>, QuerydslPredicateExecutor<TrainingHist> {
